		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('Stock');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Edit Item</span> </h4>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>
				</div>
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">Edit Item</span>
						</div>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo site_url('stock/update_item/'.$stock[0]['id']);?>" method="POST" enctype="multipart/form-data">
                        
						<!-- Other inputs -->
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title"><b>Edit Item</b></h5>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<label> <b>UPC/EAN/ISBN: <span class="text-danger">*</span></b></label>
								</div>
								<div class="col-md-6">
										<input type="text" class="form-control" name="isbn" id="isbn" required autocomplete="off" value="<?php echo $stock[0]['isbn']; ?>">
								</div> 		 
							</div> <br/>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<label> <b>Item Name: <span class="text-danger">*</span></b></label>
								</div>
								<div class="col-md-6">
										<input type="text" class="form-control" name="item_name" id="item_name" required autocomplete="off" value="<?php echo $stock[0]['item_name']; ?>">
								</div> 		 
							</div> <br/>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<label> <b>Size: <span class="text-danger"> </span></b></label>
								</div>
								<div class="col-md-6">
										<input type="text" class="form-control" name="size" id="size" autocomplete="off" value="<?php echo $stock[0]['size']; ?>">
								</div> 		 
							</div> <br/>
							...
							<div class="row">
								...
								<div class="col-md-6">
										<textarea name="desc" id="desc" class="form-control editor"><?php echo $stock[0]['desc']; ?></textarea>
								</div> 		 
							</div> <br/>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<label> <b>Choose Avatar: <span class="text-danger"> </span></b></label>
								</div>
								<div class="col-md-6">
										<input type="file" name="avatar" id="avatar" class="form-control-uniform" data-fouc>
							 ...
							 <div class="row">
								...
								<div class="col-md-2">
									<label> <b>Cost Price : <span class="text-danger">*</span></b></label>
								</div>
								<div class="col-md-6">
										<input type="text" class="form-control" name="cost_price" id="cost_price" required autocomplete="off" value="<?php echo $stock[0]['cost_price']; ?>"  onkeypress="return isNumber();">
								</div> 		 
							</div> <br/>
							 ...
							 <div class="row">
								...
								<div class="col-md-2">
									<label> <b>Selling Price : <span class="text-danger">*</span></b></label>
								</div>
								<div class="col-md-6">
										<input type="text" class="form-control" name="selling_price" id="selling_price" required autocomplete="off" value="<?php echo $stock[0]['selling_price']; ?>"  onkeypress="return isNumber();">
								</div> 		 
							</div> <br/>
							...
							<div class="row">
								...
								<div class="col-md-6">
										<input type="text" class="form-control" name="quantity" id="quantity" required autocomplete="off" value="<?php echo $stock[0]['quantity']; ?>"  onkeypress="return isNumber();">
								</div> 		 
							</div> <br/>
